...
class TestEx11(unittest.TestCase):
    ...
    def test_prix_minimums(self):
        ...
        self.assertIn(
            "Formation (prix minimums): {'Python': 1200, 'Django': 3500, 'PHP': 1600, 'Java': 1800}",
            output,
        )
    ...
    def test_formation_modifiee(self):
        ...
        self.assertIn(
            "Formation (prix minimums): {'Python': 1000, 'JavaScript': 2000, 'C++': 1800, 'Ruby': 1900}",
            output,
        )
    ...
    def test_formation1_toujours_mieux(self):
        ...
        self.assertIn(
            "Formation (prix minimums): {'Python': 1000, 'Django': 2000, 'PHP': 1500, 'Java': 1700}",
            output,
        )
    ...
    def test_formation2_toujours_mieux(self):
        ...
        self.assertIn(
            "Formation (prix minimums): {'Python': 1200, 'Django': 3000, 'PHP': 1600, 'Java': 1800}",
            output,
        )
