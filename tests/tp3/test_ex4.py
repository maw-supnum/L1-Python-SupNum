...
class TestEx4(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(self.module_path, "w", encoding="utf-8") as f:
            ...
            f.write(
                "                            groupes[groupe].append(ligne.strip())\n"
            )
            ...
            f.write(
                "            with open(f'TP{groupe}.txt', 'w', encoding='utf-8') as fichier_groupe:\n"
            )
    ...
    def test_afficher_membres_groupe(self):
        ...
        try:
            with open("../../tp3/ex4.py", "r", encoding="utf-8") as f:
                code = f.read().replace(
                    'nom_fichier = "Liste_L1.txt"', f'nom_fichier = "{self.liste_file}"'
                )
